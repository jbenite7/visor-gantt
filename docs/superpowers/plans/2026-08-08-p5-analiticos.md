...
> **Dependencia de orden — verificada el 2026-08-10. YA CUMPLIDA**, se conserva por la lección. Que
> `/upload` y `CalendarService` estén
...
>
> *(`fix/importacion-muerta` está en `main` desde `52bf682` y P5 se cerró encima, así que la condición ya se
> cumple. El aviso se queda escrito porque la lección vale para el próximo `DROP`, no porque siga pendiente.)*
